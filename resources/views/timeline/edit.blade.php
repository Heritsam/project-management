...
@section('content')
    @include('layouts.headers.title', ['title' => 'Edit Timeline', 'subtitle' => $project->name])
                    ...
                    <div class="card-body">
                        <form action="{{ route('timeline.store', $project->id) }}" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                " value="{{ $timeline->description }}" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('date_start') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="date_start" id="date_start" class="form-control form-control-alternative{{ $errors->has('date_start') ? ' is-invalid' : '' }}" value="{{ $timeline->date_start }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('date_end') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="date_end" id="date_end" class="form-control form-control-alternative{{ $errors->has('date_end') ? ' is-invalid' : '' }}" value="{{ $timeline->date_end }}" required>
